...
$(function(){
	var roleId="${role.id}";
	if(roleId==""){//新建
		$("#function_show").text("角色-创建");
		$("#roleForm").attr("action","role/add");
	}else{//修改
		$("#function_show").text("角色-修改");
		...
		<table width="99%" border="0" cellspacing="0" cellpadding="0" id="index_main_table">
			<tr>
				<td height="26" width="100%">
					...
					<span id="function_show" style="color:#002450; font-size:13px; font-weight:bold;"></span>
				</td>
			</tr>
		</table>
		...
		<table width="99%" border="0" cellspacing="0" cellpadding="0" id="index_content">
			...
			<tr>
				<td valign="middle">
					...
					<img src="image/s8.gif" width="59" height="22" style="cursor: pointer;" onclick="returnList('role');">
				</td>
			</tr>
			<tr>
							...
							<td height="56" align="left" valign="top" bgcolor="#f7fbfc">
								<table width="100%" border="0" cellspacing="0" cellpadding="0" height="100%" id="selectTable">
									<tr>
										...
										<td width="40%">
											<input type="text" name="name" value="${role.name}" class="addCText">
										</td>
										<td width="50%">&nbsp;</td>
									</tr>
