...
<link href="${ctx}/css_js/login.css" rel="stylesheet" type="text/css" />
<script type="text/javascript" src="${ctx}/css_js/ajax.js"></script>
		...
		<form action="${ctx}/logon" method="post" onsubmit="return ajaxCheck();">
			<ul>
				...
				<li class="li_btn clearfloat"><span>验证码：&nbsp;</span>
					...
					<img title="看不清楚，点击换一张" src="${ctx}/validateCode" width="80" height="26" onclick="refreshMe(this);" style="border:1px solid black;"/> 
